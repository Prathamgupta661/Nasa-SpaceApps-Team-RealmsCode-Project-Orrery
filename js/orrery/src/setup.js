...
export let pathMaterials = [
    ...
    new THREE.LineBasicMaterial({ color: 0xFFFFFF, linewidth: 1, transparent:true, opacity: 0.35 }),
    new THREE.LineBasicMaterial({ color: 0xFFFFFF, linewidth: 1, transparent:true, opacity: 0.3 }),
    new THREE.LineBasicMaterial({ color: 0xFFFFFF, linewidth: 1, transparent:true, opacity: 0.25 }),
